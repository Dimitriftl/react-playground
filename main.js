...
function Clock(props) {
    ...
    return (
        <div>
            ...
            <button onClick={() => setRandomColor()} className='glow-on-hover'>Couleur aléatoire</button>
            {' '}
            <button onClick={() => setColor('black')} className='buttonStyle noir'>couleur noir</button>
        </div>
    );
}
